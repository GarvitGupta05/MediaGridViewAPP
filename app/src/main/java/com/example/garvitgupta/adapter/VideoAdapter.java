...
public class VideoAdapter extends BaseAdapter {
    ...
    public VideoAdapter(Context context, List<Media> mediaList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap resized = ThumbnailUtils.createVideoThumbnail(
                media.getPath(), MediaStore.Video.Thumbnails.MINI_KIND);
        holder.imageView.setImageBitmap(resized);

        System.out.println("Garvit Video position : " + position);
        return convertView;
    }
}
